...
export default function AnalyticsLoading() {
  return (
    <div className="space-y-3">
      <div className="flex flex-wrap items-center gap-2 rounded-[var(--radius-container)] bg-panel p-2">
      ...
      <div className="grid gap-2.5 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6">
        {Array.from({ length: 6 }, (_, i) => (
          <div key={i} className="space-y-2 rounded-[var(--radius-container)] border border-control-line bg-control p-3">
